...
6. (Recommended) Enable <a href="http://guides.dataverse.org/en/latest/admin/make-data-count.html">Make Data Count</a> if your installation plans to make use of it at some point in the future.
