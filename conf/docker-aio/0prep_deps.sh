...
if [ ! -e dv/deps/payara-5.2022.5.zip ]; then
	echo "payara dependency prep"
	wget https://s3-eu-west-1.amazonaws.com/payara.fish/Payara+Downloads/5.2022.5/payara-5.2022.5.zip  -O dv/deps/payara-5.2022.5.zip
fi
